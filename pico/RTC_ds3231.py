# Project: Moonlight
# Module with functions to read and write to Pico RTC module
...
#               sec min hour week day month year
    ...
    def read_time(self):
        ...
        # return tuple with current time in the format (2017, 8, 23, 2, 12, 48, 0, 0)
        #The 8-tuple has the following format:
            #(year, month, day, weekday, hours, minutes, seconds, subseconds)

        time = ("20%x,%02x,%02x,%02x,%02x,%02x,%02x,%02x" %(t[6],t[5],t[4], t[3], t[2],t[1],t[0],0))
        time = time.split(",")
        timeInt = []
        for i in time:
            timeInt.append(int(i))
        timeTuple = tuple(timeInt)
